                ...
                <form>
                    <div class="form-group mb-5">
                        <select  id="categories" class="form-control form-control-lg">
                            ...
                            <?php $__currentLoopData = $mainCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        $(document).ready(function () {
            $('#categories').on('change', function () {
                ...
                $("#sub-categories").html('');
                $.ajax({
                    url: "<?php echo e(url('fetch-subCategories')); ?>",
                    type: "POST",
                    data: {
            ...
            $('#sub-categories').on('change', function () {
                ...
                $.ajax({
                    url: "<?php echo e(url('fetch-subSubCategories')); ?>",
                    type: "POST",
                    data: {
...
<?php /**PATH E:\TASKS\paytabs\CategoriesTask\resources\views/welcome.blade.php ENDPATH**/ ?>